            ...
            <div class="card overflow-hidden">
              <div class="card-body">
                <div class="d-flex justify-content-between align-items-baseline mb-4 mb-md-3 pb-2 border-bottom">
                    ...
                    @endif
                 <h4 class=" mb-0">Cricket Game List</h4>
                  <div class="d-flex align-items-center flex-wrap text-nowrap">
                  <input type="hidden" name="type" id="type" value="p_l">
                  <form method="GET" action="{{ route('admin-cricket-game-list') }}">
                ...
                <!--        <input type="text" name="search" class="form-control" placeholder="Search by game title" value="{{ request('search') }}">-->
                <!--    </div>-->
                <!--    <button type="submit" class="btn btn-primary">Search</button>-->
                <!--</form>-->
                        ...
                        <tbody>
                          @foreach ($crickets as $d)
                            <tr>
                                ...
                                <!--@if($d->status===0)-->
                                <!--    <td><a href="{{route('activate.cricket.game.status',$d->id)}}" class="badge badge-primary" style="background-color:rgb(68, 97, 242);">Activate</a></td>-->
                                <!--@else-->
                                <!--        <td><a href="{{route('deactivate.cricket.game.status',$d->id)}}" class="badge badge-primary" style="background-color:rgb(240, 36, 36);">Deactivate</a></td>-->
                                <!--@endif-->
                            </tr>
                          @endforeach
                        </tbody>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="editForm" action="{{ route('update.cricket.game.admin') }}" method="POST">
            @csrf
