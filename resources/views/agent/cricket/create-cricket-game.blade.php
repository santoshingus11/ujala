            ...
            <div class="card overflow-hidden">
              <div class="card-body">
                <div class="d-flex justify-content-between align-items-baseline mb-4 mb-md-3 pb-2 border-bottom">
                 ...
                 <h4 class=" mb-0">Create Cricket Game</h4>
                  ...
                  <input class="form-control event-search" id="url"  value="{{url('/')}}" type="hidden" placeholder="Event">
                    ...
                    <form action="{{route('admin-cricket-game-submit')}}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="row mb-4">
                            ...
                            <div class="mybets-date-picker">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <label for="game_title" class="col-12 col-form-label" style="font-weight: bolder;">Game Title</label>
                                        <input name="game_title" id="game_title" type="text" autocomplete="off" value="{{old('game_title')}}" placeholder="Game Title" class="mx-input w-100" autofocus>
                                    </div>
                                     <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <label for="game_title" class="col-12 col-form-label" style="font-weight: bolder;">Channel Id</label>
                                        <input name="channel_id" id="channel_id" type="int" autocomplete="off" value="{{old('channel_id')}}" placeholder="Channel Id" class="mx-input w-100" autofocus>
                                    </div>
