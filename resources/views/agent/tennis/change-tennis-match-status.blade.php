            ...
            <div class="card overflow-hidden">
              <div class="card-body">
                <div class="d-flex justify-content-between align-items-baseline mb-4 mb-md-3 pb-2 border-bottom">
                 ...
                 <h4 class=" mb-0">Change Tennis Match Status</h4>
                  ...
                  <input class="form-control event-search" id="url"  value="{{url('/')}}" type="hidden" placeholder="Event">
                    ...
                    <form action="{{route('admin-change-tennis-match-status-submit')}}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="row mb-4">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="mybets-date-picker">
                                <div class="row">
                                    <h5 class="mt-2 mb-2">Active/Inactive This Match <span style="color:red;">( {{ $tennis->team_name }} )</span>:</h5>
                                    <div class="col-lg-1">
