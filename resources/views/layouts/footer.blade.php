<!--<footer class="login-footer footer-color customfooter change-footer-color">-->
<footer class="login-footer footer-color customfooter change-footer-color" style="position:relative !important;">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <p class="m-b-0 upper-footer"><a href="responsiblegambling.php" class="theme1font">
            Responsible Gambling
          </a> |
          <a href="" data-bs-toggle="modal" data-bs-target="#ProhibitedTerritories" class="theme1font" role="button"><b>Prohibited Territories</b></a> |
          <a href="https://www.gamcare.org.uk/" target="blank" class="underline m-r-5"><img src="{{asset('admin/assets/icons/gamecare.svg')}}" class="game-care"></a>
          |
          <a href="https://www.begambleaware.org/" target="blank" class="underline m-r-5 begambleaware"><img src="{{asset('admin/assets/icons/gambleaware.png')}}" class="game-aware"></a> |
          <a href="https://www.gamstop.co.uk/" target="blank" class="underline m-r-5"><img src="{{asset('admin/assets/icons/gamestop.svg')}}" class="game-stop"></a>
          |
          <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#gambling" class="underline m-r-5"><img src="{{asset('admin/assets/icons/18plus.png')}}" class="footer-log game-plus"></a>
        </p>
        <p class="m-b-0 lower-footer bottom-footer"><a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#rulesandRegulations">Rules &amp; Regulations</a> <span>©
            2016-2020</span>
          Powered By <img src="{{asset('admin/assets/icons/footer-logo.png')}}"></p>
      </div>
    </div>
  </div>
</footer>
  ...
  <div class="modal-dialog">
    <div class="modal-content Prohibited-Territories">
      <div class="modal-header">
        <h4 class="modal-title" id="ProhibitedTerritoriesLabel">Prohibited Territories</h4>
        <button type="button" class="btn-close extra-hight" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <p>The right to prohibit betting on the Website by customers, whether acting alone, in a syndicate or via an
          AGENT or Sub-agent, where such customers are residing in Prohibited Jurisdictions. As of the Commencement
          Date, the following are Prohibited Jurisdictions:</p>
        <p>Algeria, Australia, Austria, Bulgaria, Canada, Cyprus, the Czech Republic, Democratic People’s Republic of
          Korea, Denmark, Europe, France (and French territories), Germany, Gibraltar, Iran, Iraq, Ireland, Italy,
          Malta, Myanmar, New Zealand, Poland, Portugal, Qatar, Romania, Singapore, South Africa, Spain, Turkey, the
          United Kingdom, the United States of America and its territories, and any other territories that Betfair may
          notify the operator</p>
      </div>
    </div>
  </div>
</div>

<!-- 18+(underage gambling) Modal -->
<div class="modal fade" id="gambling" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content Prohibited-Territories">
      <div class="modal-header">
        <h4 class="modal-title mb-0" id="staticBackdropLabel">18+(underage gambling)</h4>
        <button type="button" class="btn-close extra-hight" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <p class="mb-0"><img src="{{asset('admin.Super-Adminassets/icons/18plus.png')}}" class="footer-log"><br></p>
        <p class="mb-3">Over 18s only</p>
        <p>It is an offence for anyone under the age of 18 to open an account or to gamble on our exchange. We take
          its age-verification responsibilities very seriously. We carry out age-verification checks on all customers
          who use payment mechanisms which are available to under 18s and additionally perform random age-verification
          checks on customers using other forms of funding mechanisms. We may ask for information to verify your age
          and could restrict or suspend your account until your age is confirmed.</p>
        <h6>PLEASE NOTE THAT ANYONE UNDER THE AGE OF 18 YEARS OLD FOUND TO BE USING THIS SITE WILL HAVE ANY WINNINGS
          FORFEITED AND MAY ALSO BE REPORTED TO THE POLICE.</h6>
      </div>
    </div>
  </div>
</div>
...
<!-- login Modal -->
<script>
  function loadCareerDetails(adminId) {
                      $.ajax({
                          type: 'GET',
                      ...
                      $(document).on('click', '.Learn-More-Button', function () {
                          var adminId = $(this).data('admin-id');
                      // alert(adminId);
                          loadCareerDetails(adminId);
                      });
